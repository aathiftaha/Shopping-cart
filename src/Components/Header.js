...
import { FaAngleRight, FaAngleLeft, FaShoppingCart, FaUser, FaSearch } from 'react-icons/fa';
         ...
         <div className="header_section">
            <div className="container">
               <div className="containt_main">
                  ...
                  <span className="toggle_icon" onClick={displayNav}><img src="images/toggle-icon.png" alt='Icon'/></span>
                  <div className="dropdown">
                     ...
                     <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a className="dropdown-item" href="/">Apparel</a>
                     </div>
                  </div>
                  <div className="main">
               ...
               <div id="my_slider" className="carousel slide" data-ride="carousel">
                  <div className="carousel-inner">
                     <div className="carousel-item active">
                        <div className="row">
                           <div className="col-sm-12">
                              <h1 className="banner_taital">Get Started with<br/>Your favourite shoppings</h1>
